...
# Expected: 85937 tok/s (25.788x baseline)
...
python -m optimizer.apply \
    ...
    --backend native-pytorch-beta3 \
    --set tp_degree=4 --set weights_dtype=bf16 --set attn_implementation=eager --set compile_mode=compile-default --set batch=8 --set cp_degree=1 --set dp_degree=1 --set kv_replication=1 --set cores_used=4 --set cores_available=4

# Then measure to confirm you land within tolerance of 85937 tok/s.
