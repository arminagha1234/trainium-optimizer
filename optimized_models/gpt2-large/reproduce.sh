#!/usr/bin/env bash
# Reproduce the optimized openai-community/gpt2-large recipe.
# Backend: native-pytorch-beta3
# Expected: 30620 tok/s (7.343x baseline)
...
# Then measure to confirm you land within tolerance of 30620 tok/s.
python -m optimizer.measure --model openai-community/gpt2-large --backend native-pytorch-beta3 --all-shapes
