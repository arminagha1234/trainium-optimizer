#!/usr/bin/env bash
# Reproduce the optimized facebook/opt-1.3b recipe.
# Backend: native-pytorch-beta3
# Expected: 21077 tok/s (3.073x baseline)
...
# Then measure to confirm you land within tolerance of 21077 tok/s.
python -m optimizer.measure --model facebook/opt-1.3b --backend native-pytorch-beta3 --all-shapes
