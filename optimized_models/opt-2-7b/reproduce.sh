#!/usr/bin/env bash
# Reproduce the optimized facebook/opt-2.7b recipe.
# Backend: native-pytorch-beta3
# Expected: 11649 tok/s (2.422x baseline)
...
# Then measure to confirm you land within tolerance of 11649 tok/s.
python -m optimizer.measure --model facebook/opt-2.7b --backend native-pytorch-beta3 --all-shapes
