#!/usr/bin/env bash
# Reproduce the optimized microsoft/phi-2 recipe.
# Backend: native-pytorch-beta3
# Expected: 9841 tok/s (2.357x baseline)
...
# Then measure to confirm you land within tolerance of 9841 tok/s.
python -m optimizer.measure --model microsoft/phi-2 --backend native-pytorch-beta3 --all-shapes
