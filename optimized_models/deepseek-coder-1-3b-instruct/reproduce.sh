#!/usr/bin/env bash
# Reproduce the optimized deepseek-ai/deepseek-coder-1.3b-instruct recipe.
# Backend: native-pytorch-beta3
# Expected: 81574 tok/s (18.843x baseline)
...
# Then measure to confirm you land within tolerance of 81574 tok/s.
python -m optimizer.measure --model deepseek-ai/deepseek-coder-1.3b-instruct --backend native-pytorch-beta3 --all-shapes
