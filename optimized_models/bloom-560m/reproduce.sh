#!/usr/bin/env bash
# Reproduce the optimized bigscience/bloom-560m recipe.
# Backend: native-pytorch-beta3
# Expected: 48320 tok/s (2.826x baseline)
...
# Then measure to confirm you land within tolerance of 48320 tok/s.
python -m optimizer.measure --model bigscience/bloom-560m --backend native-pytorch-beta3 --all-shapes
