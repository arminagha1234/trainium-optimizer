#!/usr/bin/env bash
# Reproduce the optimized HuggingFaceTB/SmolLM2-1.7B recipe.
# Backend: native-pytorch-beta3
# Expected: 14460 tok/s (1.368x baseline)
...
# Then measure to confirm you land within tolerance of 14460 tok/s.
python -m optimizer.measure --model HuggingFaceTB/SmolLM2-1.7B --backend native-pytorch-beta3 --all-shapes
