#!/usr/bin/env bash
# Reproduce the optimized google/gemma-2-2b recipe.
# Backend: native-pytorch-beta3
# Expected: 34051 tok/s (17.061x baseline)
...
# Then measure to confirm you land within tolerance of 34051 tok/s.
python -m optimizer.measure --model google/gemma-2-2b --backend native-pytorch-beta3 --all-shapes
