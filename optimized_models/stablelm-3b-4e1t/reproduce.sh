#!/usr/bin/env bash
# Reproduce the optimized stabilityai/stablelm-3b-4e1t recipe.
# Backend: native-pytorch-beta3
# Expected: 7721 tok/s (2.275x baseline)
...
# Then measure to confirm you land within tolerance of 7721 tok/s.
python -m optimizer.measure --model stabilityai/stablelm-3b-4e1t --backend native-pytorch-beta3 --all-shapes
