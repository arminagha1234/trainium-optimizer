#!/usr/bin/env bash
# Reproduce the optimized Qwen/Qwen2.5-1.5B-Instruct recipe.
# Backend: native-pytorch-beta3
# Expected: 59241 tok/s (15.601x baseline)
...
# Then measure to confirm you land within tolerance of 59241 tok/s.
python -m optimizer.measure --model Qwen/Qwen2.5-1.5B-Instruct --backend native-pytorch-beta3 --all-shapes
