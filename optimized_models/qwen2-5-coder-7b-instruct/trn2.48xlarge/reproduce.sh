#!/usr/bin/env bash
# Reproduce the optimized Qwen/Qwen2.5-Coder-7B-Instruct recipe.
# Backend: native-pytorch-beta3
# Expected: 19532 tok/s (6.332x baseline)
...
# Then measure to confirm you land within tolerance of 19532 tok/s.
python -m optimizer.measure --model Qwen/Qwen2.5-Coder-7B-Instruct --backend native-pytorch-beta3 --all-shapes
