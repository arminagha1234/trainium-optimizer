#!/usr/bin/env bash
# Reproduce the optimized bigscience/bloom-1b7 recipe.
# Backend: native-pytorch-beta3
# Expected: 24852 tok/s (9.723x baseline)
...
# Then measure to confirm you land within tolerance of 24852 tok/s.
python -m optimizer.measure --model bigscience/bloom-1b7 --backend native-pytorch-beta3 --all-shapes
