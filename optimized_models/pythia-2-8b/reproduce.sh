#!/usr/bin/env bash
# Reproduce the optimized EleutherAI/pythia-2.8b recipe.
# Backend: native-pytorch-beta3
# Expected: 6450 tok/s (2.076x baseline)
...
# Then measure to confirm you land within tolerance of 6450 tok/s.
python -m optimizer.measure --model EleutherAI/pythia-2.8b --backend native-pytorch-beta3 --all-shapes
