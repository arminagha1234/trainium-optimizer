...
# Expected: 10256 tok/s (5.637x baseline)
...
python -m optimizer.apply \
    ...
    --backend native-pytorch-beta3 \
    --set tp_degree=4 --set cp_degree=2 --set batch=8 --set weights_dtype=bf16 --set compile_mode=compile-default

# Then measure to confirm you land within tolerance of 10256 tok/s.
