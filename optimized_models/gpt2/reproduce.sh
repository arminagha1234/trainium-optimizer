#!/usr/bin/env bash
# Reproduce the optimized openai-community/gpt2 recipe.
# Backend: native-pytorch-beta3
# Expected: 156974 tok/s (13.383x baseline)
...
# Then measure to confirm you land within tolerance of 156974 tok/s.
python -m optimizer.measure --model openai-community/gpt2 --backend native-pytorch-beta3 --all-shapes
