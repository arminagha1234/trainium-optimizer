#!/usr/bin/env bash
# Reproduce the optimized togethercomputer/RedPajama-INCITE-Instruct-3B-v1 recipe.
# Backend: native-pytorch-beta3
# Expected: 9824 tok/s (2.937x baseline)
...
# Then measure to confirm you land within tolerance of 9824 tok/s.
python -m optimizer.measure --model togethercomputer/RedPajama-INCITE-Instruct-3B-v1 --backend native-pytorch-beta3 --all-shapes
