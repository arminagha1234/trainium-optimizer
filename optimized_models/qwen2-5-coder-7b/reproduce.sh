#!/usr/bin/env bash
# Reproduce the optimized Qwen/Qwen2.5-Coder-7B recipe.
# Backend: native-pytorch-beta3
# Expected: 19866 tok/s (6.736x baseline)
...
# Then measure to confirm you land within tolerance of 19866 tok/s.
python -m optimizer.measure --model Qwen/Qwen2.5-Coder-7B --backend native-pytorch-beta3 --all-shapes
